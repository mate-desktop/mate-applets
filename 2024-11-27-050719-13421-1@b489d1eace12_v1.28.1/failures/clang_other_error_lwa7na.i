# 1 "cpufreq-monitor-libcpufreq.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 396 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "cpufreq-monitor-libcpufreq.c" 2
# 23 "cpufreq-monitor-libcpufreq.c"
# 1 "../../config.h" 1
# 24 "cpufreq-monitor-libcpufreq.c" 2
...
# 27 "cpufreq-monitor-libcpufreq.c" 2
...
# 28 "cpufreq-monitor-libcpufreq.c" 2
...
unsigned long cpufreq_get_sysfs_value_from_table(unsigned int cpu,
       ...
       unsigned int index,
       unsigned int size);
# 31 "cpufreq-monitor-libcpufreq.c" 2
# 1 "./cpufreq-monitor-libcpufreq.h" 1
# 25 "./cpufreq-monitor-libcpufreq.h"
...
# 26 "./cpufreq-monitor-libcpufreq.h" 2
...
# 28 "./cpufreq-monitor-libcpufreq.h" 2
# 42 "./cpufreq-monitor-libcpufreq.h"
...
GType cpufreq_monitor_libcpufreq_get_type (void) __attribute__ ((__const__));
CPUFreqMonitor *cpufreq_monitor_libcpufreq_new (guint cpu);
# 32 "cpufreq-monitor-libcpufreq.c" 2
# 1 "./cpufreq-utils.h" 1
# 30 "./cpufreq-utils.h"
...
gboolean cpufreq_file_get_contents (const gchar *filename,
                                              ...
                                              gsize *length,
                                              GError **error);
# 33 "cpufreq-monitor-libcpufreq.c" 2
...
static void cpufreq_monitor_libcpufreq_init (CPUFreqMonitorLibcpufreq *self); static void cpufreq_monitor_libcpufreq_class_init (CPUFreqMonitorLibcpufreqClass *klass); static GType cpufreq_monitor_libcpufreq_get_type_once (void); static gpointer cpufreq_monitor_libcpufreq_parent_class = ((void*)0); static gint CPUFreqMonitorLibcpufreq_private_offset; static void cpufreq_monitor_libcpufreq_class_intern_init (gpointer klass) { cpufreq_monitor_libcpufreq_parent_class = g_type_class_peek_parent (klass); if (CPUFreqMonitorLibcpufreq_private_offset != 0) g_type_class_adjust_private_offset (klass, &CPUFreqMonitorLibcpufreq_private_offset); cpufreq_monitor_libcpufreq_class_init ((CPUFreqMonitorLibcpufreqClass*) klass); } __attribute__ ((__unused__)) static inline gpointer cpufreq_monitor_libcpufreq_get_instance_private (CPUFreqMonitorLibcpufreq *self) { return (((gpointer) ((guint8*) (self) + (glong) (CPUFreqMonitorLibcpufreq_private_offset)))); } GType cpufreq_monitor_libcpufreq_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = cpufreq_monitor_libcpufreq_get_type_once (); (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; } __attribute__ ((__noinline__)) static GType cpufreq_monitor_libcpufreq_get_type_once (void) { GType g_define_type_id = g_type_register_static_simple ((cpufreq_monitor_get_type ()), g_intern_static_string ("CPUFreqMonitorLibcpufreq"), sizeof (CPUFreqMonitorLibcpufreqClass), (GClassInitFunc)(void (*)(void)) cpufreq_monitor_libcpufreq_class_intern_init, sizeof (CPUFreqMonitorLibcpufreq), (GInstanceInitFunc)(void (*)(void)) cpufreq_monitor_libcpufreq_init, (GTypeFlags) 0); { {{};} } return g_define_type_id; }
                                        ...
                                        GObjectConstructParam *construct_params)
{
    ...
    object =
        ((((GObjectClass*) (void *) ((cpufreq_monitor_libcpufreq_parent_class)))))
            ->constructor (type,
                           n_construct_properties,
                           construct_params);

    g_object_get (((((GObject*) (void *) ((object))))),
                  "cpu", &cpu,
                  ((void*)0));

    if (cpufreq_get_hardware_limits (cpu, &min_freq, &max_freq) != 0) {
        g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "Error getting CPUINFO_MAX\n");
        max_freq = -1;
    }

    g_object_set (((((GObject*) (void *) ((object))))),
...
cpufreq_monitor_libcpufreq_class_init (CPUFreqMonitorLibcpufreqClass *klass)
{
    ...
    CPUFreqMonitorClass *monitor_class = ((((CPUFreqMonitorClass*) (void *) ((klass)))));
...
cpufreq_monitor_libcpufreq_new (guint cpu)
{
    ...
    monitor = g_object_new ((cpufreq_monitor_libcpufreq_get_type ()),
                            "cpu", cpu, ((void*)0));

    return ((((CPUFreqMonitor*) (void *) ((monitor)))));
}
...
cpufreq_monitor_libcpufreq_run (CPUFreqMonitor *monitor)
{
    ...
    g_object_get (((((GObject*) (void *) ((monitor))))), "cpu", &cpu, ((void*)0));
    ...
    if (!policy) {
        ...
        if (cpupower_is_cpu_online (cpu)) {
            ...
            g_object_set (((((GObject*) (void *) ((monitor))))), "online", (0), ((void*)0));
            return (!(0));
        }
        return (0);
    }
...
cpufreq_monitor_libcpufreq_get_available_frequencies (CPUFreqMonitor *monitor)
{
    ...
    g_object_get (((((GObject*) (void *) ((monitor))))),
                  "cpu", &cpu, ((void*)0));
...
cpufreq_monitor_libcpufreq_get_available_governors (CPUFreqMonitor *monitor)
{
    ...
    for (gov = govs; gov; gov = gov->next) {
        list = g_list_prepend (list, g_strdup_inline (gov->governor));
    }
