...
# 1 "./cpufreq-selector-service.h" 1
# 24 "./cpufreq-selector-service.h"
# 1 "/usr/include/dbus-1.0/dbus/dbus-glib.h" 1
# 30 "/usr/include/dbus-1.0/dbus/dbus-glib.h"
...
# 31 "/usr/include/dbus-1.0/dbus/dbus-glib.h" 2
# 40 "/usr/include/dbus-1.0/dbus/dbus-glib.h"
...
# 131 "/usr/include/dbus-1.0/dbus/dbus-glib.h"
...
# 151 "/usr/include/dbus-1.0/dbus/dbus-glib.h"
...
# 1 "/usr/include/dbus-1.0/dbus/dbus-gtype-specialized.h" 1
# 34 "/usr/include/dbus-1.0/dbus/dbus-gtype-specialized.h"
...
# 187 "/usr/include/dbus-1.0/dbus/dbus-glib.h" 2
# 200 "/usr/include/dbus-1.0/dbus/dbus-glib.h"
...
GType dbus_g_signature_get_g_type (void) __attribute__ ((__const__));
...
# 226 "/usr/include/dbus-1.0/dbus/dbus-glib.h"
struct _DBusGProxy
{
...
# 1 "/usr/include/dbus-1.0/dbus/dbus-gvalue-parse-variant.h" 1
# 37 "/usr/include/dbus-1.0/dbus/dbus-gvalue-parse-variant.h"
void dbus_g_value_parse_g_variant (GVariant *variant, GValue *value);
# 345 "/usr/include/dbus-1.0/dbus/dbus-glib.h" 2
# 25 "./cpufreq-selector-service.h" 2
# 40 "./cpufreq-selector-service.h"
enum {
...
GType cpufreq_selector_service_get_type (void) __attribute__ ((__const__));
GType cpufreq_selector_service_error_get_type (void) __attribute__ ((__const__));
GQuark cpufreq_selector_service_error_quark (void) __attribute__ ((__const__));
...
# 1 "./cpufreq-selector-factory.h" 1
# 23 "./cpufreq-selector-factory.h"
...
gboolean cpufreq_selector_set_governor (CPUFreqSelector *selector,
                                         const gchar *governor,
                                         GError **error);
# 24 "./cpufreq-selector-factory.h" 2
...
static gint cpu = 0;
static gchar *governor = ((void*)0);
static gulong frequency = 0;

static const GOptionEntry options[] = {
    { "cpu", 'c', 0, G_OPTION_ARG_INT, &cpu, "CPU Number", ((void*)0) },
    { "governor", 'g', 0, G_OPTION_ARG_STRING, &governor, "Governor", ((void*)0) },
    { "frequency", 'f', 0, G_OPTION_ARG_INT, &frequency, "Frequency in KHz", ((void*)0) },
    { ((void*)0) }
};
...
# 187 "main.c"
    ...
    g_option_context_add_main_entries (context, options, ((void*)0));
    ...
    if (!cpufreq_selector_service_register ((cpufreq_selector_service_get_instance ()), &error)) {
    ...
    g_object_weak_ref (((((GObject*) (void *) (((cpufreq_selector_service_get_instance ())))))),
                       (GWeakNotify) do_exit,
                       loop);
