# 1 "cpufreq-selector.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 396 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "cpufreq-selector.c" 2
# 22 "cpufreq-selector.c"
...
# 23 "cpufreq-selector.c" 2
# 1 "./cpufreq-selector.h" 1
# 25 "./cpufreq-selector.h"
...
# 26 "./cpufreq-selector.h" 2
# 36 "./cpufreq-selector.h"
enum {
...
GType cpufreq_selector_get_type (void) __attribute__ ((__const__));
GQuark cpufreq_selector_error_quark (void) __attribute__ ((__const__));
...
static void cpufreq_selector_init (CPUFreqSelector *self); static void cpufreq_selector_class_init (CPUFreqSelectorClass *klass); static GType cpufreq_selector_get_type_once (void); static gpointer cpufreq_selector_parent_class = ((void*)0); static gint CPUFreqSelector_private_offset; static void cpufreq_selector_class_intern_init (gpointer klass) { cpufreq_selector_parent_class = g_type_class_peek_parent (klass); if (CPUFreqSelector_private_offset != 0) g_type_class_adjust_private_offset (klass, &CPUFreqSelector_private_offset); cpufreq_selector_class_init ((CPUFreqSelectorClass*) klass); } __attribute__ ((__unused__)) static inline gpointer cpufreq_selector_get_instance_private (CPUFreqSelector *self) { return (((gpointer) ((guint8*) (self) + (glong) (CPUFreqSelector_private_offset)))); } GType cpufreq_selector_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = cpufreq_selector_get_type_once (); (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; } __attribute__ ((__noinline__)) static GType cpufreq_selector_get_type_once (void) { GType g_define_type_id = g_type_register_static_simple (((GType) ((20) << (2))), g_intern_static_string ("CPUFreqSelector"), sizeof (CPUFreqSelectorClass), (GClassInitFunc)(void (*)(void)) cpufreq_selector_class_intern_init, sizeof (CPUFreqSelector), (GInstanceInitFunc)(void (*)(void)) cpufreq_selector_init, (GTypeFlags) G_TYPE_FLAG_ABSTRACT); { {{ CPUFreqSelector_private_offset = g_type_add_instance_private (g_define_type_id, sizeof (CPUFreqSelectorPrivate)); };} } return g_define_type_id; }
...
cpufreq_selector_class_init (CPUFreqSelectorClass *klass)
{
    ...
    klass->set_frequency = ((void*)0);
    klass->set_governor = ((void*)0);
...
cpufreq_selector_set_property (GObject *object,
                               ...
                               GParamSpec *spec)
{
    CPUFreqSelector *selector = ((((CPUFreqSelector*) (void *) ((object)))));
    ...
    case PROP_CPU:
        ...
        break;
    default:
        do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((spec)); guint _glib__property_id = ((prop_id)); g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "%s:%d: invalid %s id %u for \"%s\" of type '%s' in '%s'", "cpufreq-selector.c", 107, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
    }
}
                               ...
                               GParamSpec *spec)
{
    ...
    case PROP_CPU:
        ...
        break;
    default:
        do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((spec)); guint _glib__property_id = ((prop_id)); g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "%s:%d: invalid %s id %u for \"%s\" of type '%s' in '%s'", "cpufreq-selector.c", 124, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
    }
}
                                ...
                                GError **error)
{
    ...
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_10; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((selector)); GType __t = ((cpufreq_selector_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_10 = 1; else _g_boolean_var_10 = 0; _g_boolean_var_10; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "CPUFREQ_IS_SELECTOR (selector)"); return ((0)); } } while (0);
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_11; if (frequency > 0) _g_boolean_var_11 = 1; else _g_boolean_var_11 = 0; _g_boolean_var_11; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "frequency > 0"); return ((0)); } } while (0);

    class = ((((CPUFreqSelectorClass*) (((GTypeInstance*) ((selector)))->g_class))));
                               ...
                               GError **error)
{
    ...
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_12; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((selector)); GType __t = ((cpufreq_selector_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_12 = 1; else _g_boolean_var_12 = 0; _g_boolean_var_12; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "CPUFREQ_IS_SELECTOR (selector)"); return ((0)); } } while (0);
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_13; if (governor != ((void*)0)) _g_boolean_var_13 = 1; else _g_boolean_var_13 = 0; _g_boolean_var_13; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "governor != NULL"); return ((0)); } } while (0);
