# 1 "cpufreq-selector-libcpufreq.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 396 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "cpufreq-selector-libcpufreq.c" 2
# 23 "cpufreq-selector-libcpufreq.c"
# 1 "../../../config.h" 1
# 24 "cpufreq-selector-libcpufreq.c" 2
...
# 27 "cpufreq-selector-libcpufreq.c" 2
...
# 1 "/usr/bin/../lib/clang/19/include/stdarg.h" 1 3
# 26 "/usr/include/glib-2.0/glib/gprintf.h" 2
...
# 28 "/usr/include/glib-2.0/glib/gstdio.h" 2
...
# 28 "cpufreq-selector-libcpufreq.c" 2
# 1 "/usr/include/cpufreq.h" 1 3 4
# 11 "/usr/include/cpufreq.h" 3 4
...
# 57 "/usr/include/cpufreq.h" 3 4
unsigned long cpufreq_get_freq_kernel(unsigned int cpu);

unsigned long cpufreq_get_freq_hardware(unsigned int cpu);
# 68 "/usr/include/cpufreq.h" 3 4
unsigned long cpufreq_get_transition_latency(unsigned int cpu);
# 77 "/usr/include/cpufreq.h" 3 4
int cpufreq_get_hardware_limits(unsigned int cpu,
    unsigned long *min,
    unsigned long *max);
# 88 "/usr/include/cpufreq.h" 3 4
char *cpufreq_get_driver(unsigned int cpu);

void cpufreq_put_driver(char *ptr);
# 100 "/usr/include/cpufreq.h" 3 4
struct cpufreq_policy *cpufreq_get_policy(unsigned int cpu);

void cpufreq_put_policy(struct cpufreq_policy *policy);
# 113 "/usr/include/cpufreq.h" 3 4
struct cpufreq_available_governors
*cpufreq_get_available_governors(unsigned int cpu);

void cpufreq_put_available_governors(
 struct cpufreq_available_governors *first);
# 127 "/usr/include/cpufreq.h" 3 4
struct cpufreq_available_frequencies
...
# 203 "/usr/include/cpufreq.h" 3 4
int cpufreq_set_frequency(unsigned int cpu,
    unsigned long target_frequency);
# 213 "/usr/include/cpufreq.h" 3 4
unsigned long cpufreq_get_sysfs_value_from_table(unsigned int cpu,
       const char **table,
       unsigned int index,
       unsigned int size);
# 29 "cpufreq-selector-libcpufreq.c" 2

# 1 "/usr/include/linux/version.h" 1 3 4
# 31 "cpufreq-selector-libcpufreq.c" 2

# 1 "./cpufreq-selector-libcpufreq.h" 1
# 25 "./cpufreq-selector-libcpufreq.h"
...
# 26 "./cpufreq-selector-libcpufreq.h" 2
...
gboolean cpufreq_selector_set_governor (CPUFreqSelector *selector,
                                         const gchar *governor,
                                         GError **error);
# 28 "./cpufreq-selector-libcpufreq.h" 2
# 44 "./cpufreq-selector-libcpufreq.h"
...
GType cpufreq_selector_libcpufreq_get_type (void) __attribute__ ((__const__));
CPUFreqSelector *cpufreq_selector_libcpufreq_new (guint cpu);
# 33 "cpufreq-selector-libcpufreq.c" 2
...
static void cpufreq_selector_libcpufreq_init (CPUFreqSelectorLibcpufreq *self); static void cpufreq_selector_libcpufreq_class_init (CPUFreqSelectorLibcpufreqClass *klass); static GType cpufreq_selector_libcpufreq_get_type_once (void); static gpointer cpufreq_selector_libcpufreq_parent_class = ((void*)0); static gint CPUFreqSelectorLibcpufreq_private_offset; static void cpufreq_selector_libcpufreq_class_intern_init (gpointer klass) { cpufreq_selector_libcpufreq_parent_class = g_type_class_peek_parent (klass); if (CPUFreqSelectorLibcpufreq_private_offset != 0) g_type_class_adjust_private_offset (klass, &CPUFreqSelectorLibcpufreq_private_offset); cpufreq_selector_libcpufreq_class_init ((CPUFreqSelectorLibcpufreqClass*) klass); } __attribute__ ((__unused__)) static inline gpointer cpufreq_selector_libcpufreq_get_instance_private (CPUFreqSelectorLibcpufreq *self) { return (((gpointer) ((guint8*) (self) + (glong) (CPUFreqSelectorLibcpufreq_private_offset)))); } GType cpufreq_selector_libcpufreq_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = cpufreq_selector_libcpufreq_get_type_once (); (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; } __attribute__ ((__noinline__)) static GType cpufreq_selector_libcpufreq_get_type_once (void) { GType g_define_type_id = g_type_register_static_simple ((cpufreq_selector_get_type ()), g_intern_static_string ("CPUFreqSelectorLibcpufreq"), sizeof (CPUFreqSelectorLibcpufreqClass), (GClassInitFunc)(void (*)(void)) cpufreq_selector_libcpufreq_class_intern_init, sizeof (CPUFreqSelectorLibcpufreq), (GInstanceInitFunc)(void (*)(void)) cpufreq_selector_libcpufreq_init, (GTypeFlags) 0); { {{};} } return g_define_type_id; }
...
{
    CPUFreqSelectorClass *selector_class = ((((CPUFreqSelectorClass*) (void *) ((klass)))));
...
cpufreq_selector_libcpufreq_new (guint cpu)
{
    ...
    selector = ((((CPUFreqSelector*) (void *) ((g_object_new ((cpufreq_selector_libcpufreq_get_type ()), "cpu", cpu, ((void*)0)))))));
...
{
    guint cpu;
    gint dist = 2147483647;
    guint retval = 0;
    CPUFreqFrequencyList *freqs, *freq;

    g_object_get (((((GObject*) (void *) ((selector))))),
                  "cpu", &cpu,
                  ((void*)0));
                                           ...
                                           GError **error)
{
    ...
    freq = cpufreq_selector_libcpufreq_get_valid_frequency (((((CPUFreqSelectorLibcpufreq*) (void *) ((selector))))),
                                                            frequency);
    if (cpufreq_set_frequency (cpu, freq) != 0) {
        g_set_error (error,
                     (cpufreq_selector_error_quark ()),
                     SELECTOR_ERROR_SET_FREQUENCY,
                                          ...
                                          GError **error)
{
    ...
    selector_libcpufreq = ((((CPUFreqSelectorLibcpufreq*) (void *) ((selector)))));
