...
# 1 "./apmlib/apm.h" 1
# 26 "./apmlib/apm.h"
# 1 "/usr/include/linux/apm_bios.h" 1 3 4
# 20 "/usr/include/linux/apm_bios.h" 3 4
...
# 21 "/usr/include/linux/apm_bios.h" 2 3 4
...
# 133 "/usr/include/linux/apm_bios.h" 3 4
...
# 134 "/usr/include/linux/apm_bios.h" 2 3 4
# 27 "./apmlib/apm.h" 2
...
# 1 "/usr/bin/../lib/clang/19/include/stddef.h" 1 3 4
# 88 "/usr/bin/../lib/clang/19/include/stddef.h" 3 4
# 1 "/usr/bin/../lib/clang/19/include/__stddef_ptrdiff_t.h" 1 3 4
# 89 "/usr/bin/../lib/clang/19/include/stddef.h" 2 3 4
...
# 1 "/usr/bin/../lib/clang/19/include/__stddef_wchar_t.h" 1 3 4
# 104 "/usr/bin/../lib/clang/19/include/stddef.h" 2 3 4
# 128 "/usr/bin/../lib/clang/19/include/stddef.h" 3 4
# 1 "/usr/bin/../lib/clang/19/include/__stddef_offsetof.h" 1 3 4
# 129 "/usr/bin/../lib/clang/19/include/stddef.h" 2 3 4
...
read_file (const char* file, char* buf, size_t bufsize)
{
    ...
    if (len < 0)
    {
        ...
        {
            g_log ("battstat_applet", G_LOG_LEVEL_MESSAGE, "Error reading %s: %s", file, g_strerror ((*__errno_location ())));
        }
    ...
    for (i = 0, value = key = buf, reading_key = (!(0)); i < len; i++)
    {
        ...
        else if (buf[i] == '\n')
        {
            ...
            g_hash_table_insert (hash, key, g_strchomp (g_strchug (value)));
            key = buf + i + 1;
        }
        else if (reading_key)
        {
...
read_long (GHashTable *hash, const char *key)
{
    ...
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_8; if (hash) _g_boolean_var_8 = 1; else _g_boolean_var_8 = 0; _g_boolean_var_8; }), 1))) { } else { g_return_if_fail_warning ("battstat_applet", ((const char*) (__func__)), "hash"); return (0); } } while (0);
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_9; if (key) _g_boolean_var_9 = 1; else _g_boolean_var_9 = 0; _g_boolean_var_9; }), 1))) { } else { g_return_if_fail_warning ("battstat_applet", ((const char*) (__func__)), "key"); return (0); } } while (0);

    s = g_hash_table_lookup (hash, key);
    return s ? strtol (s, ((void*)0), 10) : 0;
}
...
read_ulong (GHashTable *hash, const char *key)
{
  char *s;
    ...
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_10; if (hash) _g_boolean_var_10 = 1; else _g_boolean_var_10 = 0; _g_boolean_var_10; }), 1))) { } else { g_return_if_fail_warning ("battstat_applet", ((const char*) (__func__)), "hash"); return (0); } } while (0);
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_11; if (key) _g_boolean_var_11 = 1; else _g_boolean_var_11 = 0; _g_boolean_var_11; }), 1))) { } else { g_return_if_fail_warning ("battstat_applet", ((const char*) (__func__)), "key"); return (0); } } while (0);

    s = g_hash_table_lookup (hash, key);
    return s ? strtoul (s, ((void*)0), 10) : 0;
}
...
{
    gchar *ac_state = ((void*)0);
    DIR * procdir;
    struct dirent * procdirentry;
    char buf[8192];
    GHashTable *hash;
    gboolean have_adaptor = (0);

    acpiinfo->ac_online = (0);
...
update_battery_info (struct acpi_info* acpiinfo)
{
    ...
    while ((procdirentry = readdir (procdir)))
    {
        if (procdirentry->d_name[0] != '.')
        {
            batt_info = g_strconcat ("/proc/acpi/battery/", procdirentry->d_name, "/info", ((void*)0));
...
acpi_linux_init (struct acpi_info * acpiinfo)
{
    ...
    do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_12; if (acpiinfo) _g_boolean_var_12 = 1; else _g_boolean_var_12 = 0; _g_boolean_var_12; }), 1)) ; else g_assertion_message_expr ("battstat_applet", "acpi-linux.c", 264, ((const char*) (__func__)), "acpiinfo"); } while (0);

    if (g_file_get_contents ("/sys/module/acpi/parameters/acpica_version", &pbuf, ((void*)0), ((void*)0))) {
        acpi_ver = strtoul (pbuf, ((void*)0), 10);
        g_free (pbuf);
...
{
    do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_13; if (acpiinfo) _g_boolean_var_13 = 1; else _g_boolean_var_13 = 0; _g_boolean_var_13; }), 1)) ; else g_assertion_message_expr ("battstat_applet", "acpi-linux.c", 316, ((const char*) (__func__)), "acpiinfo"); } while (0);
...
gboolean acpi_process_event (struct acpi_info * acpiinfo)
{
    ...
    if (gerror != ((void*)0)) {
        g_log ("battstat_applet", G_LOG_LEVEL_WARNING, "%s", gerror->message);
        g_error_free (gerror);
    }
    ...
    (__builtin_constant_p ((0)) ? (((0)) ? (g_string_free) ((buffer), ((0))) : g_string_free_and_steal (buffer)) : (g_string_free) ((buffer), ((0))));
    return result;
}
...
acpi_linux_read (struct apm_info *apminfo, struct acpi_info * acpiinfo)
{
    ...
    gboolean charging;
    GHashTable *hash;
    gchar* batt_state = ((void*)0);
    DIR * procdir;
    struct dirent * procdirentry;
    char buf[8192];

    do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_14; if (acpiinfo) _g_boolean_var_14 = 1; else _g_boolean_var_14 = 0; _g_boolean_var_14; }), 1)) ; else g_assertion_message_expr ("battstat_applet", "acpi-linux.c", 406, ((const char*) (__func__)), "acpiinfo"); } while (0);
# 415 "acpi-linux.c"
    do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_15; if (apminfo) _g_boolean_var_15 = 1; else _g_boolean_var_15 = 0; _g_boolean_var_15; }), 1)) ; else g_assertion_message_expr ("battstat_applet", "acpi-linux.c", 415, ((const char*) (__func__)), "apminfo"); } while (0);
