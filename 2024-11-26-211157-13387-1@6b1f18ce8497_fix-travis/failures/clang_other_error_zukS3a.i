# 1 "cpufreq-monitor-factory.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 396 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "cpufreq-monitor-factory.c" 2
# 23 "cpufreq-monitor-factory.c"
# 1 "../../config.h" 1
# 24 "cpufreq-monitor-factory.c" 2
...
# 27 "cpufreq-monitor-factory.c" 2
...
# 28 "cpufreq-monitor-factory.c" 2

# 1 "./cpufreq-applet.h" 1
# 25 "./cpufreq-applet.h"
...
GType cpufreq_applet_get_type (void) __attribute__ ((__const__));

GType cpufreq_applet_show_mode_get_type (void) __attribute__ ((__const__));
GType cpufreq_applet_show_text_mode_get_type (void) __attribute__ ((__const__));
# 30 "cpufreq-monitor-factory.c" 2
# 1 "./cpufreq-utils.h" 1
# 30 "./cpufreq-utils.h"
...
gboolean cpufreq_file_get_contents (const gchar *filename,
                                              ...
                                              gsize *length,
                                              GError **error);
# 31 "cpufreq-monitor-factory.c" 2
# 1 "./cpufreq-monitor-factory.h" 1
# 25 "./cpufreq-monitor-factory.h"
...
# 34 "cpufreq-monitor-factory.c" 2
