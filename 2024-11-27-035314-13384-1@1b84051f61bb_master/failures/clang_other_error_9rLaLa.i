...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "cpufreq-monitor.c" 2
# 22 "cpufreq-monitor.c"
# 1 "./cpufreq-monitor.h" 1
# 25 "./cpufreq-monitor.h"
# 1 "/usr/include/glib-2.0/glib-object.h" 1
# 24 "/usr/include/glib-2.0/glib-object.h"
# 1 "/usr/include/glib-2.0/gobject/gbinding.h" 1
# 30 "/usr/include/glib-2.0/gobject/gbinding.h"
...
# 26 "./cpufreq-monitor.h" 2
# 36 "./cpufreq-monitor.h"
...
GType cpufreq_monitor_get_type (void) __attribute__ ((__const__));
...
static void cpufreq_monitor_init (CPUFreqMonitor *self); static void cpufreq_monitor_class_init (CPUFreqMonitorClass *klass); static GType cpufreq_monitor_get_type_once (void); static gpointer cpufreq_monitor_parent_class = ((void*)0); static gint CPUFreqMonitor_private_offset; static void cpufreq_monitor_class_intern_init (gpointer klass) { cpufreq_monitor_parent_class = g_type_class_peek_parent (klass); if (CPUFreqMonitor_private_offset != 0) g_type_class_adjust_private_offset (klass, &CPUFreqMonitor_private_offset); cpufreq_monitor_class_init ((CPUFreqMonitorClass*) klass); } __attribute__ ((__unused__)) static inline gpointer cpufreq_monitor_get_instance_private (CPUFreqMonitor *self) { return (((gpointer) ((guint8*) (self) + (glong) (CPUFreqMonitor_private_offset)))); } GType cpufreq_monitor_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = cpufreq_monitor_get_type_once (); (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; } __attribute__ ((__noinline__)) static GType cpufreq_monitor_get_type_once (void) { GType g_define_type_id = g_type_register_static_simple (((GType) ((20) << (2))), g_intern_static_string ("CPUFreqMonitor"), sizeof (CPUFreqMonitorClass), (GClassInitFunc)(void (*)(void)) cpufreq_monitor_class_intern_init, sizeof (CPUFreqMonitor), (GInstanceInitFunc)(void (*)(void)) cpufreq_monitor_init, (GTypeFlags) G_TYPE_FLAG_ABSTRACT); { {{ CPUFreqMonitor_private_offset = g_type_add_instance_private (g_define_type_id, sizeof (CPUFreqMonitorPrivate)); };} } return g_define_type_id; }
...
cpufreq_monitor_init (CPUFreqMonitor *monitor)
{
    ...
    monitor->priv->governor = ((void*)0);
    monitor->priv->available_freqs = ((void*)0);
    monitor->priv->available_govs = ((void*)0);
    monitor->priv->timeout_handler = 0;

    monitor->priv->changed = (0);
}

static void
cpufreq_monitor_class_init (CPUFreqMonitorClass *klass)
{
    GObjectClass *object_class = ((((GObjectClass*) (void *) ((klass)))));
    ...
    klass->run = ((void*)0);
    klass->get_available_frequencies = ((void*)0);
    klass->get_available_governors = ((void*)0);
    ...
    signals[SIGNAL_CHANGED] =
            g_signal_new ("changed",
                          ...
                          G_SIGNAL_RUN_LAST,
                          ((glong) __builtin_offsetof(CPUFreqMonitorClass, changed)),
                          ((void*)0), ((void*)0),
...
{
    CPUFreqMonitor *monitor = ((((CPUFreqMonitor*) (void *) ((object)))));

    monitor->priv->online = (0);
    ...
    ((((GObjectClass*) (void *) ((cpufreq_monitor_parent_class)))))->finalize (object);
}
                              ...
                              GParamSpec *spec)
{
    ...
    monitor = ((((CPUFreqMonitor*) (void *) ((object)))));
    ...
    case PROP_GOVERNOR: {
        ...
        if (monitor->priv->governor) {
            if (g_ascii_strcasecmp (gov, monitor->priv->governor) != 0) {
                g_free (monitor->priv->governor);
                monitor->priv->governor = gov ? g_strdup_inline (gov) : ((void*)0);
                monitor->priv->changed = (!(0));
            }
        } else {
            monitor->priv->governor = gov ? g_strdup_inline (gov) : ((void*)0);
    ...
    default:
        do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((spec)); guint _glib__property_id = ((prop_id)); g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "%s:%d: invalid %s id %u for \"%s\" of type '%s' in '%s'", "cpufreq-monitor.c", 241, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
    }
}
                              ...
                              GParamSpec *spec)
{
    ...
    case PROP_GOVERNOR:
        ...
        break;
    default:
        do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((spec)); guint _glib__property_id = ((prop_id)); g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "%s:%d: invalid %s id %u for \"%s\" of type '%s' in '%s'", "cpufreq-monitor.c", 272, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
    }
}
...
cpufreq_monitor_run_cb (CPUFreqMonitor *monitor)
{
    ...
    class = ((((CPUFreqMonitorClass*) (((GTypeInstance*) ((monitor)))->g_class))));
...
{
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_10; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((monitor)); GType __t = ((cpufreq_monitor_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_10 = 1; else _g_boolean_var_10 = 0; _g_boolean_var_10; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "CPUFREQ_IS_MONITOR (monitor)"); return; } } while (0);
...
cpufreq_monitor_get_available_frequencies (CPUFreqMonitor *monitor)
{
    ...
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_11; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((monitor)); GType __t = ((cpufreq_monitor_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_11 = 1; else _g_boolean_var_11 = 0; _g_boolean_var_11; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "CPUFREQ_IS_MONITOR (monitor)"); return (((void*)0)); } } while (0);
...
cpufreq_monitor_get_available_governors (CPUFreqMonitor *monitor)
{
    ...
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_12; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((monitor)); GType __t = ((cpufreq_monitor_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_12 = 1; else _g_boolean_var_12 = 0; _g_boolean_var_12; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "CPUFREQ_IS_MONITOR (monitor)"); return (((void*)0)); } } while (0);
...
{
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_13; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((monitor)); GType __t = ((cpufreq_monitor_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_13 = 1; else _g_boolean_var_13 = 0; _g_boolean_var_13; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "CPUFREQ_IS_MONITOR (monitor)"); return (0); } } while (0);
...
{
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_14; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((monitor)); GType __t = ((cpufreq_monitor_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_14 = 1; else _g_boolean_var_14 = 0; _g_boolean_var_14; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "CPUFREQ_IS_MONITOR (monitor)"); return; } } while (0);

    g_object_set (((((GObject*) (void *) ((monitor))))),
                  "cpu", cpu, ((void*)0));
}
...
{
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_15; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((monitor)); GType __t = ((cpufreq_monitor_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_15 = 1; else _g_boolean_var_15 = 0; _g_boolean_var_15; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "CPUFREQ_IS_MONITOR (monitor)"); return (-1); } } while (0);
...
{
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_16; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((monitor)); GType __t = ((cpufreq_monitor_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_16 = 1; else _g_boolean_var_16 = 0; _g_boolean_var_16; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "CPUFREQ_IS_MONITOR (monitor)"); return (((void*)0)); } } while (0);
...
{
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_17; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((monitor)); GType __t = ((cpufreq_monitor_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_17 = 1; else _g_boolean_var_17 = 0; _g_boolean_var_17; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "CPUFREQ_IS_MONITOR (monitor)"); return (-1); } } while (0);
